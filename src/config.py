...
opt = CN()
opt.gan_type = 'BigGAN'  # choices=['BigGAN', 'ProgGAN', 'StyleGAN2','SNGAN' ,'StyleGAN']
...
opt.algo = CN()
opt.algo.ours = CN()
opt.algo.ours.model_name = 'biggan_imagenet'  # choices = ['pggan_celebahq1024',stylegan_animeface512,stylegan_car512,stylegan_cat256]
