...
opt = CN()
opt.gan_type = 'BigGAN'  # choices=['BigGAN', 'ProgGAN', 'StyleGAN2','SNGAN']
...
opt.pretrained_gen_root = '/home/ubuntu/src/disentagled_latent_dirs/src/models/pretrained/new_generators/BigGAN/BigGAN/G_ema.pth'
opt.deformator_pretrained = '/home/ubuntu/src/disentagled_latent_dirs/src/models/pretrained/new_generators/BigGAN/pretrained/BigGAN/models/deformator_0.pt'
...
opt.algo.ours.num_directions = 120
opt.algo.ours.latent_dim = 120
