...
import models.StyleGAN.Losses as Losses
from models.StyleGAN import update_average
from models.StyleGAN.Blocks import DiscriminatorTop, DiscriminatorBlock, InputBlock, GSynthesisBlock
from models.StyleGAN.CustomLayers import EqualizedConv2d, PixelNormLayer, EqualizedLinear, Truncation


class GMapping(nn.Module):

    def __init__(self, latent_size=512, dlatent_size=512, dlatent_broadcast=None,
                 mapping_layers=3, mapping_fmaps=64, mapping_lrmul=0.01, mapping_nonlinearity='lrelu', ##todo
...
class GSynthesis(nn.Module):
    ...
    def __init__(self, dlatent_size=512, num_channels=3, resolution=1024,
        ...
        def nf(stage):
            fmap_list = [64,64,64,64,32,16]
            return  fmap_list[stage]
        ...
        for current_depth in range(start_depth, self.depth):
            ...
            for epoch in range(1, epochs[current_depth] + 1):
                ...
                for (i, batch) in enumerate(data, 1):
                    ...
                    images = batch.float().to(self.device).view(-1,1,64,64)
